...
from utils.decorators import iterate1
from utils.tensor import same_shape
from utils.types import is_tensor, is_numpy, is_list, is_dict
...
def post_process_inv_depth(inv_depth, inv_depth_flipped, method='mean'):
    ...
    """
    from utils.flip import flip_lr
